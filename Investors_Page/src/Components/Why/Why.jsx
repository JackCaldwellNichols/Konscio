...
import './why.scss'
import {faArrowTrendUp, faBookOpenReader, faCalendar, faCalendarTimes, faCircleCheck, faClock, faHandshake, faHandshakeAlt, faHandshakeAngle, faHandshakeSimple, faHandshakeSlash, faHelmetUn, faHourglass1, faLeaf, faMoneyBillTransfer, faShield, faThumbsDown, faThumbsUp, faTimeline} from '@fortawesome/free-solid-svg-icons'
...
const Why = () => {
  return (
    <div className='why'>
        ...
        <a target='_blank' className='whyBtn' href='https://www.vidasostenible.info/inversores/'>Saber Más</a>
    </div>
  )
}
